...
faq:
  - question: "¿El facturador gratuito de la DIAN sirve para una tienda o restaurante?"
    answer: "Sí, es legal y genera facturas válidas, pero está pensado para cumplir la obligación tributaria, no para operar un mostrador: no tiene catálogo de productos, no controla inventario ni fiado, y cada factura se llena manualmente campo por campo."
  - question: "¿Qué diferencia hay entre el facturador de la DIAN y un sistema como Rosiv?"
    answer: "El de la DIAN solo genera la factura. Un sistema como Rosiv genera la factura desde el mismo punto de venta, con catálogo, descuento automático de inventario y reportes de ventas, funcionando incluso sin internet."
  - question: "¿Cuándo conviene usar el facturador gratis de la DIAN en vez de pagar un sistema?"
    answer: "Cuando el negocio factura muy pocas veces al mes y no necesita controlar inventario ni ver reportes de ventas. Para un negocio que factura decenas de veces al día, el tiempo que ahorra un sistema con catálogo suele valer más que el costo del plan."
---
