---
title: "\"Mañana te pago\": qué hacer cuando el fiado se te volvió costumbre"
description: "El fiado es parte de la cultura de la tienda de barrio y el restaurante familiar en Colombia. Cómo cobrarlo sin pelear con el cliente y evitar que se convierta en plata perdida."
pubDate: 2026-08-13
keywords: "cliente fiado no paga, control de fiado tienda de barrio, cómo cobrar fiado sin pelear"
faq:
  - question: "¿Qué hago si un cliente fiado no me paga?"
    answer: "Registra fecha y monto de cada fiado apenas pasa, en vez de confiar en la memoria, y cóbrale por costumbre y no solo cuando ya te urge la plata. Un límite de fiado claro desde el principio evita que la deuda crezca hasta volverse un problema."
  - question: "¿Cómo evito que el fiado se me vuelva costumbre en la tienda?"
    answer: "Poniendo un tope de fiado desde el primer día, registrando cada fiado en el momento (no 'después'), y revisando las cuentas por cobrar con la misma regularidad con la que revisas la caja, no solo cuando ya falta la plata."
  - question: "¿Por qué es tan difícil controlar el fiado en una tienda de barrio?"
    answer: "Porque cada fiado individual parece pequeño e inofensivo, pero la suma nunca se lleva por escrito de forma confiable. El cuaderno se pierde, se moja o se llena de tachones, y termina generando desconfianza entre el tendero y el cliente en vez de resolver el problema."
---
...
1. **Registra el fiado en el momento, no después.** El "después lo anoto" es donde se pierde la mitad del control. Si no se anota en el instante, se te olvida el monto exacto o directamente se te olvida que pasó.
2. **Ponle un límite claro desde el principio, no cuando ya es tarde.** No es incómodo decir "hasta $50.000 fiado, de ahí para adelante hablamos" el primer día. Sí es incómodo decirlo cuando ya debe $300.000.
3. **Muéstrale el número, no se lo digas de memoria.** "Debes $47.000" genera dudas si sale de tu cabeza. Un registro con fecha y detalle de cada fiado no se discute — se ve.
4. **Cobra por costumbre, no por necesidad.** Si solo le recuerdas al cliente cuando ya te urge la plata, se siente como que estás desesperado. Si tienes una rutina fija de repaso de cuentas, se siente como algo normal del negocio.
...
Si quieres empezar a ordenar la caja mientras tanto, puedes [empezar gratis con Rosiv](https://web.rosivhub.com) y tener ese control desde el primer cierre del día.
